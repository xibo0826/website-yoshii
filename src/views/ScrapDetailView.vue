<template>
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white shadow">
            <div class="container mx-auto px-4 py-3">
                <div class="flex items-center text-sm text-gray-600">
                    <router-link :to="{ name: 'home' }" class="hover:text-[#2E7D32]">ホーム</router-link>
        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <!-- 買取対応エリア -->
            <div class="mb-16">
                <h2 class="text-2xl font-bold mb-8">買取対応エリア</h2>
                <div class="bg-white rounded-lg shadow-lg p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h3 class="text-lg font-bold mb-4">主な対応エリア</h3>
                            <ul class="space-y-2 text-gray-600">
                                <li class="flex items-center">
                                    <i class="fas fa-map-marker-alt text-[#2E7D32] mr-2"></i>
                                    <span>白河市を中心に福島県南部全域</span>
                                </li>
                                <li class="flex items-center">
                                    <i class="fas fa-map-marker-alt text-[#2E7D32] mr-2"></i>
                                    <span>栃木県北部エリア</span>
                        ...
                        <div>
                            <h3 class="text-lg font-bold mb-4">出張買取について</h3>
                            <p class="text-gray-600">
                                お客様の元へ出張し、その場で査定・買取を行います。
                                大量の場合や重量物の場合は、出張買取がお勧めです。
                                まずはお気軽にご相談ください。
                            </p>
                        </div>
                    </div>
...
export default {
    ...
    created() {
        const category = categoryData[`type${this.categoryId}`];
        if (category) {
